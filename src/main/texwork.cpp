...
int make_texture_resize_work()
{
    ...
    basic_shader.createFrom({
        { "C://CTools//Projects//mglw-strip//assets//shaders//compute_basic/shader.vert", GL_VERTEX_SHADER   },
        { "C://CTools//Projects//mglw-strip//assets//shaders//compute_basic/shader.frag", GL_FRAGMENT_SHADER }
    });
    basic_compute.createFrom({{ "C://CTools//Projects//mglw-strip//assets//shaders//compute_basic/shader.comp", GL_COMPUTE_SHADER  }});
